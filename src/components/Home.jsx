      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="py-4 max-w-xl text-white">
            Hello visitors, I'm vikas Looking an opportunity as a frontend
          ...
          <div>
            {/* <Link
              ...
              smooth
              duration={500}
              className="group text-white w-fit px-6 py-3 my-2 flex items-center rounded-2xl md:rounded-2xl rounded-mg bg-sky-500 cursor-pointer"
            >
              Portfolio
